...
export default function HomePage() {
    ...
    return (
        ...
        <div className={style.mainContainer}>
            <header>
                <video className={style.myVideo} src='\dogVideo3.mp4' width="100vw" height="100%" autoPlay loop muted
                 ></video>
            ...
            <div className={style.cardAndImgCon}>
                <div className={style.imgCon}>
                    ...
                    <div className={style.headerImgOne}></div>
                </div>
                    ...
                    <div className={style.imgBox}>
                        <div>
                            <div className={style.groomingImg}>
                                {/* <img src='/dist/assests/headerimagetwo.jpg' width="100%" height="100%"></img> */}
                                <div className={style.grommingImgOne}></div>
                            </div>
                            <h3>Grooming</h3>
                    ...
                    <div className={style.imgBox}>
                        <div>
                            <div className={style.trainingImg}>
                                ...
                                <div className={style.trainingImgOne}></div>
                            </div>
                            <h3>Training</h3>
                    ...
                    <div className={style.imgBox}>
                        <div>
                            <div className={style.daysCareImg}>
                                ...
                                <div className={style.daysCareImgOne}></div>
                            </div>
            ...
            <div className={style.cardTwoAndImgCon}>
                ...
                <div className={style.imgConTwo}>
                    {/* <img src='./Images/headerimagefive.jpg'></img> */}
                    <div className={style.headerImgFive}></div>
                </div>
            </div>
            ...
            <div className={style.imgConThreeOne}>
                    ...
                    <div className={style.headerImgSix}></div>
                </div>
                ...
                <div className={style.imgConThreeTwo}>
                    ...
                    <div className={style.headerImgSeven}></div>
                </div>
